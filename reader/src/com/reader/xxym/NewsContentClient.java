...
public abstract class NewsContentClient  {
	...
	public void load(final int id,boolean cache)
	{
		Map<String, Object> news = ndao.getNewsByID(id);
		if(cache)
		{
			if(news.containsKey("content")&&news.get("content")!=null)
			{
			...
			String url =news.get("url").toString();
			 new Downloader(context){
					...
					protected void onPostExecute(String result) {
						...
						Pattern p = Pattern.compile("<div class=\"article_p\">((\\s|\n|.)+?)</div>",Pattern.MULTILINE);
