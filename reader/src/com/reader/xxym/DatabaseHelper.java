...
public class DatabaseHelper {
	...
	private class DatabaseOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase arg0) {
			arg0.execSQL("create table news (_id integer primary key autoincrement, "
					+ "title text not null,description text not null,"
					+ "url text not null,"
					+ "kindid integer not null,cover text null);");
			arg0.execSQL("create table content (_id integer primary key autoincrement, "
		...
		public void onUpgrade(SQLiteDatabase arg0, int arg1, int arg2) {
			...
			arg0.execSQL("drop table if exists content;");
			onCreate(arg0);
		}
